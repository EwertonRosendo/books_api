  ...
  module Books
    class UpdateBook < ::Mutations::BaseMutation
      ...
      def resolve(id:, title:, description:, author:, publisher:, url_image:, published_at:)
        ...
        Book.find_by(:id => id).update!(id: id, title: title, description: description, author: thisAuthor,published_at: published_at, publisher: publisher, url_image: url_image)
      end
